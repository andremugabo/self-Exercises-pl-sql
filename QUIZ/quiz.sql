CREATE OR REPLACE PROCEDURE ass_student AS
   ...
   CURSOR s_intake IS SELECT  * FROM STUDENTS JOIN DEPARTMENT ON STUDENTS.DEPARTMENT_ID = DEPARTMENT.ID  WHERE REGISTRATION_DATE BETWEEN '1-MAR-22' AND '30-apr-22';
   ...
   END LOOP;
   dbms_output.put_line(COUNT_ART);
   CLOSE f_intake;
